...
import edu.unq.arqsoft.mottesi_olmedo_tolaba.backend.service.ProfessorService;
...
@Path("/professors")
public class ProfessorRest  extends GenericRest<Professor> {
	...
	@Override
	public GenericService<Professor> getService() {
	...
	@POST
	public Response create(@Context HttpServletRequest request, Professor user) {
		return super.create(user);
	}


	@PUT
	public Response update(@Context HttpServletRequest request, Professor user) {
