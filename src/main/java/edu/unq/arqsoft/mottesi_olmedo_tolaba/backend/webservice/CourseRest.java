...
import edu.unq.arqsoft.mottesi_olmedo_tolaba.backend.service.CourseService;
...
@Path("/courses")
public class CourseRest  extends GenericRest<Course> {

	@Autowired
	private ResponseGenerator responseGenerator;
	
	@Autowired
	private CourseService courseOfferService;
	

	@Override
	public GenericService<Course> getService() {
		return courseOfferService;
	}
	...
	@POST
	public Response create(@Context HttpServletRequest request, Course user) {
		return super.create(user);
	}


	@PUT
	public Response update(@Context HttpServletRequest request, Course user) {
