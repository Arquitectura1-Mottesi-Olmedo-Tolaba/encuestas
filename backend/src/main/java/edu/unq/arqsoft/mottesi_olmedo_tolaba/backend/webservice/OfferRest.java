...
import edu.unq.arqsoft.mottesi_olmedo_tolaba.backend.service.OfferService;
...
@Path("/offers")
public class OfferRest  extends GenericRest<Offer> {
	...
	@POST
	public Response create(@Context HttpServletRequest request, Offer user) {
		return super.create(user);
	}


	@PUT
	public Response update(@Context HttpServletRequest request, Offer user) {
