...
import edu.unq.arqsoft.mottesi_olmedo_tolaba.backend.service.DegreeService;
...
public class DegreeRest  extends GenericRest<Degree> {
	...
	@POST
	public Response create(@Context HttpServletRequest request, Degree user) {
		return super.create(user);
	}


	@PUT
	public Response update(@Context HttpServletRequest request, Degree user) {
